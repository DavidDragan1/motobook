	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li><a href="#"><i class="fa fa-files-o"></i> Makes</a>
				<ul>
				<li><a href="create-brand.php">Add a Make</a></li>
				<li><a href="manage-brands.php">Manage Makes</a></li>
				</ul>
				</li>

				<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
					<ul>
						<li><a href="post-avehical.php">Add a Vehicle</a></li>
				...
				<li><a href="manage-conactusquery.php"><i class="fa fa-desktop"></i> Manage Contact Enquiries</a></li>
