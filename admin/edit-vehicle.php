...
<head>
	...
	<title>Motobook Admin Panel | Edit Vehicle Info</title>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Price Per Day(in GBP)<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
												...
												<label class="col-sm-2 control-label">Select Gearbox Type<span
														style="color:red">*</span></label>
												<div class="col-sm-4">
