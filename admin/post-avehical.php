...
<head>
	...
	<title>Motobook Admin Panel | Post Vehicle</title>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Price Per Day (in GBP)<span style="color:red">*</span></label>
												<div class="col-sm-4">
													<input type="text" name="priceperday" class="form-control" required>
												</div>
												<label class="col-sm-2 control-label">Select Gearbox Type<span style="color:red">*</span></label>
												<div class="col-sm-4">
										...
										<div class="col-sm-6">				
											...
											<div class="col-sm-4">
												<div class="checkbox checkbox-inline">
													...
													<label for="brakeassist"> Crash Bars </label>
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="checkbox checkbox-inline">
													...
													<label for="inlineCheckbox5"> EFI </label>
												</div>
											</div>
