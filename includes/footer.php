      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
          ...
          <div class="newsletter-form">
            ...
            <p class="subscribed-text">* We send great riding tips and tricks to help get you ready for your full licence.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 col-md-pull-6">
          <p class="copy-right">Copyright &copy; <?=date("Y")?> yourbrand. <span class="faded">Website Proudly Developed by <a href="wtslondon.com">wts</a></span></p>
        </div>
      </div>
    </div>
  </div>
